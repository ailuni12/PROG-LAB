//14. Crear un programa de ordenador para gestionar los resultados de la quiniela de fútbol.
...
//	¿Qué modificación habría que hacer en las tablas para guardar todos los resultados de todas las
